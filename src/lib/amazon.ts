...
export const amazonServices: AmazonService[] = [
  {
    ...
    facts: {
      it: "Prova gratuita eventuale per clienti idonei, secondo i termini Amazon in vigore.",
      en: "A free trial may be available for eligible customers, under Amazon's current terms.",
    },
  ...
  },
  {
    ...
    cta: { it: "Scopri Audible", en: "Explore Audible" },
  ...
  },
  {
    ...
    cta: { it: "Scopri Kindle Unlimited", en: "Explore Kindle Unlimited" },
  ...
  },
  {
    ...
    facts: {
      it: "Periodo promozionale eventuale per studenti idonei, secondo i requisiti Amazon in vigore.",
      en: "A promotional period may exist for eligible students, under Amazon's current requirements.",
    },
